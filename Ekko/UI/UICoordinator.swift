...
enum SettingsPage: String, CaseIterable, Identifiable {
    ...
    var subtitle: String {
        ...
        case .dictation: return "How Ekko listens and how text arrives."
        case .models: return "Speech models installed on this Mac."
        case .languages: return "The language Ekko expects to hear."
        case .shortcut: return "The key you press to start dictating."
        case .permissions: return "What Ekko needs from macOS."
