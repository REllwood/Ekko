...
enum DictationFailure: Equatable, Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .microphoneDenied: return "Ekko needs microphone access to hear you."
        case .accessibilityDenied: return "Ekko needs Accessibility access to type into other apps."
