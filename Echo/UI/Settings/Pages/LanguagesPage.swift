...
struct LanguagesPage: View {
        ...
        VStack(alignment: .leading, spacing: EchoSpacing.l) {
            ...
            if query.isEmpty {
                section(title: "Detection") {
                    row(code: nil, name: "Auto-detect", detail: "Echo works out the language from what it hears.")
                }
    ...
    private func section<Content: View>(title: String, @ViewBuilder content: () -> Content) -> some View {
        VStack(alignment: .leading, spacing: EchoSpacing.s) {
            ...
            EchoCard(padding: EchoSpacing.xs) {
...
private struct LanguageRow: View {
    ...
    var body: some View {
        Button(action: action) {
            ...
            .frame(height: 32)
            .background(
                isHovering ? EchoColor.surfaceMuted : Color.clear,
