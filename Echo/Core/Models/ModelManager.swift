...
final class ModelManager {
    ...
    /// Root passed to WhisperKit as `downloadBase`: ~/Library/Application Support/Echo/Models
    ...
    init(settings: SettingsStore) {
        ...
        self.downloadBase = support.appendingPathComponent("Echo/Models", isDirectory: true)
