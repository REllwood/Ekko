...
// WhisperKit exports its own `TranscriptionResult`/`TranscriptionSegment`, so Echo's types are
...
final class WhisperKitEngine: TranscriptionEngine {
    ...
    func transcribe(_ audio: AudioBuffer16k, options: TranscriptionOptions) async throws -> Echo.TranscriptionResult {
...
private actor WhisperKitCore {
    ...
    func transcribe(_ audio: AudioBuffer16k, options: TranscriptionOptions) async throws -> Echo.TranscriptionResult {
        ...
        guard !audio.isEmpty else {
            return Echo.TranscriptionResult(
                text: "",
        ...
        do {
            ...
            var segments: [Echo.TranscriptionSegment] = []
    ...
    private static func makeResult(
        segments: [Echo.TranscriptionSegment],
